...
RSpec.describe GrammarStats do
  describe "#check" do
    context "when text starts with a capital letter and ends with sentence-ending puntuation mark" do
      it "returns true" do
        gs = GrammarStats.new
        text = "Hello, Planet!"
    ...
    context "when text doesn't starts with a capital letter or ends with sentence-punctuation make" do
      it "returns false" do
        gs = GrammarStats.new
        text = "hello, planet"
